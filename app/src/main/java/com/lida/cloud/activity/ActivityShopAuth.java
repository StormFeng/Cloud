...
import com.lida.cloud.adapter.AdapterPic;
...
public class ActivityShopAuth extends TakePhotoActivity implements ApiCallback {
    ...
    public void onApiSuccess(NetResult res, String tag) {
        ...
        if (res.isOK()) {
            if ("seladd".equals(tag)) {
                UIHelper.t(ActivityShopAuth.this, "提交成功！");
                setResult(RESULT_OK);
                finish();
            }
            if ("type".equals(tag)) {
