...
public class AdapterProvince extends RecyclerView.Adapter<AdapterProvince.ViewHolder> {
    ...
    public AdapterProvince(Activity mContext, List<CityBean> mDatas) {
    ...
    public AdapterProvince setDatas(List<CityBean> datas) {
        mDatas = datas;
        return this;
    }

    @Override
    public AdapterProvince.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mInflater.inflate(R.layout.item_city, parent, false));
    }

    @Override
    public void onBindViewHolder(final AdapterProvince.ViewHolder holder, final int position) {
        ...
        holder.content.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("provinceId", cityBean.getId());
                UIHelper.jumpForResult(mContext, ActivityCity.class, bundle, 1001);
            }
        });
    }
